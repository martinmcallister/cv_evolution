...
plt.scatter(0.0529848884*24,0.064,marker='o',color='k',s=15,alpha=0.3)
plt.errorbar(0.0529848884*24,0.064,yerr=0.006,ls='none',color='k',capsize=None,linewidth=1,alpha=0.3)
plt.text(0.0529848884*24,0.065,'  PHL 1445\n (noGPs)',color='k',size=10,alpha=0.3)
...
# with GPs (10 ecl fit)
plt.scatter(0.0529848884*24,0.071,marker='o',color='k',s=15)
plt.errorbar(0.0529848884*24,0.071,yerr=[[0.005],[0.009]],ls='none',color='k',capsize=None,linewidth=1)
plt.text(0.0529848884*24,0.070,'  PHL 1445\n  (GPs)',color='k',size=10)
...
plt.scatter(0.0627919557*24,0.0436,marker='o',color='g',s=15)
plt.errorbar(0.0627919557*24,0.0436,yerr=[[0.0017],[0.0025]],ls='none',color='g',capsize=None,linewidth=1)
plt.text(0.0627919557*24,0.0430,'  SDSS\n  1057',color='g',size=10)
...
plt.text(0.04625828*24,0.0530,'  SDSS\n  1507',color='k',size=10)
...
plt.text(0.0570067*24,0.0440,'  SDSS\n  1035',color='k',size=10)
...
plt.plot(P_optimal,m2_optimal,c='r',linewidth=1.5,alpha=0.8)
#plt.plot(P_standard,m2_standard,c='r',linestyle='dashed')
#plt.plot(P_BD_1,m2_BD_1,c='b',linewidth=1.5)
plt.plot(P_BD_2,m2_BD_2,c='b',linestyle='--',linewidth=1.5,alpha=0.8)
plt.plot(P_BD_3,m2_BD_3,c='b',linestyle='-.',linewidth=1.5,alpha=0.8)
plt.plot(P_BD_4,m2_BD_4,c='b',linestyle=':',linewidth=1.5,alpha=0.8)
...
#plt.errorbar(1.373,0.035,xerr=0.048,ls='none',color='k',capsize=5,linewidth=1)
#plt.errorbar(1.373,0.098,xerr=0.062,ls='none',color='k',capsize=5,linewidth=2)
#plt.errorbar(1.373,0.098,xerr=0.033,ls='none',color='k',capsize=5,linewidth=2)
#plt.axvline(1.373,linestyle='dashed',color='gray')

plt.arrow(1.373,0.035,0.0475,0,width=0.0003,head_width=0.002,head_length=0.0002,color='k',linewidth=0.5,alpha=0.8) #G09
plt.arrow(1.373,0.035,-0.0475,0,width=0.0003,head_width=0.002,head_length=0.0002,color='k',linewidth=0.5,alpha=0.8) #G09
...
plt.savefig("m2vsP_sdss1057.pdf")
plt.show()
